                    ...
                    <? foreach ($cartProduct as $key => $item) {?>
                        ...
                        <div class="basket_product flex">
                            ...
                            <div class="basket_price" id="<?= $key ?>">
                                <? $prodAttr =  $item['modelProductAttr']; $prodPrice = $productModel->sale?$productModel->getSaleCalcPrice($prodAttr):$productModel->getCalcPrice($prodAttr, false);?>
                                <?= Yii::$app->formatter->asInteger($prodPrice*$item['count']) ?> <i class="fas fa-ruble-sign"></i>
                            </div>
